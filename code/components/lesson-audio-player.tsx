...
export function LessonAudioPlayer({ lessonId, autoPlay = false, className }: LessonAudioPlayerProps) {
  ...
  return (
    <div className={cn("flex flex-col gap-3 p-4 rounded-lg bg-secondary/50", className)}>
